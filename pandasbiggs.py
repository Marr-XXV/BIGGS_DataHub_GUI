"""pandasbiggs: data processing helpers and CSVProcessor used by analytics/report tooling.

Connections:
- CSVProcessor loads record2025.csv and provides filter, aggregation, and accessor utilities.
- Used by missing_generate.py to compute missing dates and by other analysis scripts.
- Combiner/fetcher produce record2025.csv which is the input for CSVProcessor.
"""
import pandas as pd
import numpy as np
import decimal
